...
class ProductViewSet(viewsets.ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        ...
        for img in images:
            created_images.append(ProductImage.objects.create(product=product, image=img))

        if not product.representative_image and created_images:
            first_image = created_images[0]
            product.representative_image = first_image.image
            product.save()
